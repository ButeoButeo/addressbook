...
//Run Query
$db->query("SELECT `contacts`.`name`, `contacts`.`id`, `contacts`.`first_name`, `city`.`id_city`, `contacts`.`street`, `contacts`.`zipcode`, `city`.`name_city`,`contacts`.`fk_id_city`
FROM contacts
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php echo $contact->name_city; ?>
					</td>
					<td>
						<?php echo $contact->zipcode; ?>
					</td>
					<td>
						<ul class="button-group">
							<li>
								<a href="#" class="button success tiny" data-reveal-id="editModal<?php echo $contact->id; ?>" data-contact-id="<?php echo $contact->id; ?>">Edit</a>
											...
											<div class="large-4 columns">
												<label>City
													<select class="form-control" name="city">
														<?php echo "<option value='$contact->fk_id_city'>".$contact->name_city. "</option>";	?>
